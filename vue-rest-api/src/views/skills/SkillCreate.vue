      ...
      <div class="mt-12">
            ...
            class="max-w-md mx-auto p-4 bg-white shadow-md rounded-md">
                  <div class="space-y-6">
                        ...
                        <div class="mb-6">
                              <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 text-dark">Slug</label>
                        ...
                        <div class="mt-5">
                              <button type="submit" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded text-white">Create</button>
                        </div>
                  </div>
            </form>
      </div>
